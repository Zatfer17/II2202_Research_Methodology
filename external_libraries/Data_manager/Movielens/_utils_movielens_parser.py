...
def _loadICM_tags(tags_path, header=True, separator=','):
    ...
    # Tags
    from external_libraries.Data_manager.TagPreprocessing import tagFilterAndStemming
...
def _loadUCM(UCM_path, header=True, separator=','):
    ...
    # Genres
    from external_libraries.Data_manager.IncrementalSparseMatrix import IncrementalSparseMatrix_FilterIDs
