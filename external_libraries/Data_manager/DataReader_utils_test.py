...
class MyTestCase(unittest.TestCase):
    ...
    def test_reconcile_mapper_with_removed_tokens(self):
        ...
        from external_libraries.Data_manager.DataReader_utils import reconcile_mapper_with_removed_tokens
    ...
    def test_split_big_CSR_in_columns(self):
        ...
        from external_libraries.Data_manager.DataReader_utils import split_big_CSR_in_columns
