		...
		$DynamicElements.each( function() {
			...
			if ( !$El.hasClass('ds_no_flags') )
			{
				...
				else if ( bIgnored )
				{
					...
					$El.append( '<div class="ds_flag ds_ignored_flag">IGNORATO&nbsp;&nbsp;</div>');
				}
		...
		if( strAppIDs )
		{
			...
			if (!bIgnored)
			{
				var fnClick = function ()
				{
					...
					$elSource.append( '<div class="ds_flag ds_ignored_flag">IGNORATO&nbsp;&nbsp;</div>');
					for( var i=0; i<rgAppIds.length; i++ )
...
function UpdateStoreBannerForAdditionalCartDiscount( nCartDiscount )
{
	...
	<div class="placeHolder_lunarSale2019_giftActiveBar">	\
		...
		<div class="lunar_sale_title"><img src="https://store.cloudflare.steamstatic.com/public/images/promo/lunar2019/lny2019_title_it.png"/></div> \
